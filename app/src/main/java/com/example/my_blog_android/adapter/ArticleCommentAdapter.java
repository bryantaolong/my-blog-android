...
public class ArticleCommentAdapter extends RecyclerView.Adapter<ArticleCommentAdapter.CommentViewHolder> {
    ...
    public ArticleCommentAdapter(List<ArticleComment> comments, Context context) {
        this.comments = comments;
        this.context = context;
        this.commentService = ApiClient.getArticleCommentService();
        this.sessionManager = SessionManager.getInstance(context);
    }

    public void updateComments(List<ArticleComment> newComments) {
        this.comments.clear();
    ...
    public void onBindViewHolder(@NonNull CommentViewHolder holder, int position) {
        ArticleComment comment = comments.get(position);
